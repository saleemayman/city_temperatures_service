...
CREATE INDEX date_col_idx ON public.global_land_temperatures_by_city (dt, city, latitude, longitude);

-- cluster the table on the indexed column so data is order by dt.
CLUSTER public.global_land_temperatures_by_city USING multicol_primaryKey_col_idx;
